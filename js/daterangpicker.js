  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    this.container
      ...
      .on(
        ...
        "select.yearselect",
        $.proxy(this.updateMonthYear, this)
      )
      .on(
        "change.daterangepicker",
        "select.monthselect",
  ...
  DateRangePicker.prototype = {
    ...
    setOptions: function (options, callback) {
      ...
      if (typeof options.showRangeInputsOnCustomRangeOnly === "boolean") {
        this.showRangeInputsOnCustomRangeOnly =
          options.showRangeInputsOnCustomRangeOnly;
        if (this.showRangeInputsOnCustomRangeOnly) this.hideRangeInputs();
      }
    ...
    showCalendars: function () {
      if (this.showRangeInputsOnCustomRangeOnly) this.showRangeInputs();
    ...
    renderCalendar: function (calendar, selected, minDate, maxDate, side) {
      ...
      for (var row = 0; row < 6; row++) {
        ...
        for (var col = 0; col < 7; col++) {
          ...
          if (
            (minDate && calendar[row][col].isBefore(minDate, "day")) ||
      ...
      if (this.timePicker) {
        ...
        if (
          minDate &&
          (side == "left" || this.singleDatePicker) &&
          selected.format("YYYY-MM-DD") == minDate.format("YYYY-MM-DD")
        ) {
        ...
        if (
          ...
          selected.format("YYYY-MM-DD") == maxDate.format("YYYY-MM-DD")
        ) {
        ...
        if (
          minDate &&
          (side == "left" || this.singleDatePicker) &&
          selected.format("YYYY-MM-DD h A") == minDate.format("YYYY-MM-DD h A")
        ) {
        ...
        if (
          maxDate &&
          (side == "right" || this.singleDatePicker) &&
          selected.format("YYYY-MM-DD h A") == maxDate.format("YYYY-MM-DD h A")
        ) {
